          ...
          children: [Column(
            children: [
              ...
              CupertinoListSection.insetGrouped(
                header: Row(children: [
                  SizedBox(width: 14,),
                  Text('MY DEVICES', style: TextStyle(fontSize: 14, color: CupertinoColors.systemGrey, fontWeight: FontWeight.w300)),
                  SizedBox(width: 14,),
              ...
              CupertinoListSection.insetGrouped(
                header: Row(children: [
                  SizedBox(width: 14,),
                  Text('OTHER DEVICES', style: TextStyle(fontSize: 14, color: CupertinoColors.systemGrey, fontWeight: FontWeight.w300)),
                  SizedBox(width: 14,),
